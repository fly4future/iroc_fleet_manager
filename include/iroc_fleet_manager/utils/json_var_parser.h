...
using parseable_t = std::variant<json *, bool *, int *, double *, std::string *, std::vector<int> *, std::vector<double> *, std::vector<std::string> *,
                                 ct::Point2D *, ct::Point3D *, ct::Reference *, ct::Waypoint *, ct::Subtask *, std::vector<ct::Point2D> *, std::vector<std::vector<ct::Point2D>> *,
                                 std::vector<std::pair<std::vector<ct::Point2D>, double>> *, std::vector<ct::Point3D> *, std::vector<ct::Reference> *, std::vector<ct::Waypoint> *, std::vector<ct::Subtask> *>;
