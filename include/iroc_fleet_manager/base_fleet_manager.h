...
namespace iroc_fleet_manager
{
  ...
  // TODO use only template for action type
  ...
  template <typename ActionServer_T, typename ActionGoal_T, typename ActionResult_T, typename ActionFeedback_T>
  void BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::timerMain([[maybe_unused]] const ros::TimerEvent& event)
  {
    ...
    {
      {
        ...
        any_failure = std::any_of(fleet_mission_handlers_.handlers.begin(), fleet_mission_handlers_.handlers.end(),
                                  [](const auto& handler) { return handler.got_result && !handler.result.success; });
      }
      ...
      {
        std::scoped_lock lock(fleet_mission_handlers_.mtx);
        got_all_results = std::all_of(fleet_mission_handlers_.handlers.begin(), fleet_mission_handlers_.handlers.end(),
        ...
        all_success = std::all_of(fleet_mission_handlers_.handlers.begin(), fleet_mission_handlers_.handlers.end(),
                                  [](const auto& handler) { return handler.result.success; });
      }
  ...
  template <typename ActionServer_T, typename ActionGoal_T, typename ActionResult_T, typename ActionFeedback_T>
  bool BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::changeFleetMissionStateCallback(mrs_msgs::String::Request& req,
        ...
        for (auto& rh : fleet_mission_handlers_.handlers)
        {
          ...
          if (!resp.success)
          {
            ...
            ROS_WARN_STREAM("[IROCFleetManager]: "
                            << "Call for robot \"" << rh.robot_name << "\" was not successful with message: " << resp.message << "\n");
  ...
  template <typename ActionServer_T, typename ActionGoal_T, typename ActionResult_T, typename ActionFeedback_T>
  bool BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::changeRobotMissionStateCallback(
      iroc_fleet_manager::ChangeRobotMissionStateSrv::Request& req, iroc_fleet_manager::ChangeRobotMissionStateSrv::Response& res)
  {
    ...
    if (action_server_ptr_->isActive())
    {
      if (req.type == "start")
      {
        ...
        if (!resp.success)
        {
          success = false;
          ROS_WARN_STREAM("[IROCFleetManager]: "
                          << "Call for robot \"" << req.robot_name << "\" was not successful with message: " << resp.message << "\n");
  ...
  /* missionDoneCallback //{ */
  template <typename ActionServer_T, typename ActionGoal_T, typename ActionResult_T, typename ActionFeedback_T>
  void BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::missionDoneCallback(
      const SimpleClientGoalState& state, const iroc_mission_handler::waypointMissionResultConstPtr& result, const std::string& robot_name)
  {
    ...
    if (result == NULL)
    {
      ...
      ROS_WARN_STREAM("[IROCFleetManager]: Robot " << robot_name
                                                   << " mission_handler died/ or restarted while mission was active, and action server connection was lost!, "
                                                      "reconnection is not currently handled, if mission handler was restarted need to upload a new mission!");
      iroc_fleet_manager::WaypointFleetManagerResult action_server_result;
      action_server_result.success = false;
      action_server_result.message =
          "Probably mission_handler died, and action server connection was lost!, reconnection is not currently handled, if mission handler was restarted need "
          "to upload a new mission!";
      action_server_result.robots_results = getRobotResults();
    ...
    if (result->success)
    {
      ROS_INFO_STREAM("[IROCFleetManager]: Action server on robot " << robot_name << " finished with state: \"" << state.toString()
                                                                    << "\". Result message is: \"" << result->message << "\"");
    } else
    {
      ROS_WARN_STREAM("[IROCFleetManager]: Action server on robot " << robot_name << " finished with state: \"" << state.toString()
                                                                    << "\". Result message is: \"" << result->message << "\"");
    }
  ...
  template <typename ActionServer_T, typename ActionGoal_T, typename ActionResult_T, typename ActionFeedback_T>
  void BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::missionFeedbackCallback(
      const iroc_mission_handler::waypointMissionFeedbackConstPtr& feedback, const std::string& robot_name)
  {
  ...
  template <typename ActionServer_T, typename ActionGoal_T, typename ActionResult_T, typename ActionFeedback_T>
  void BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::actionCallbackGoal()
  {
    std::scoped_lock lock(action_server_mutex_);
    boost::shared_ptr<const iroc_fleet_manager::WaypointFleetManagerGoal> new_action_server_goal = action_server_ptr_->acceptNewGoal();
  ...
  template <typename ActionServer_T, typename ActionGoal_T, typename ActionResult_T, typename ActionFeedback_T>
  void BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::actionCallbackPreempt()
  {
    std::scoped_lock lock(action_server_mutex_);
    if (action_server_ptr_->isActive())
    {
  ...
  /* startRobotClients() //{ */
  template <typename ActionServer_T, typename ActionGoal_T, typename ActionResult_T, typename ActionFeedback_T>
  std::map<std::string, typename BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::result_t>
  BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::startRobotClients(const ActionGoal_T& goal)
  {
    std::scoped_lock lck(fleet_mission_handlers_.mtx);
...

    {
      ...
      for (const auto& robot : goal.robots)
      {
        ...
        action_client_ptr->sendGoal(
            action_goal, [this](const auto& state, const auto& result) { missionDoneCallback(state, result); }, [this]() { missionActiveCallback(); },
            [this](const auto& feedback) { missionFeedbackCallback(feedback); });
  ...
  template <typename ActionServer_T, typename ActionGoal_T, typename ActionResult_T, typename ActionFeedback_T>
  ActionServerFeedback BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::processAggregatedFeedbackInfo(
      const std::vector<iroc_fleet_manager::WaypointMissionRobotFeedback>& robots_feedback)
  {
  ...
  /* getRobotResults() //{ */
  template <typename ActionServer_T, typename ActionGoal_T, typename ActionResult_T, typename ActionFeedback_T>
  std::vector<iroc_fleet_manager::WaypointMissionRobotResult>
  BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::getRobotResults()
  {
  ...
  std::tuple<std::string, std::string> BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::processFeedbackMsg()
  {
    ...
    auto all_loaded = std::all_of(fleet_mission_handlers_.handlers.begin(), fleet_mission_handlers_.handlers.end(),
                                  [](const auto& handler) { return handler.feedback.message == "MISSION_LOADED"; });
    ...
    auto all_executing = std::all_of(fleet_mission_handlers_.handlers.begin(), fleet_mission_handlers_.handlers.end(),
                                     [](const auto& handler) { return handler.feedback.message == "EXECUTING"; });
    ...
    auto all_paused = std::all_of(fleet_mission_handlers_.handlers.begin(), fleet_mission_handlers_.handlers.end(),
                                  [](const auto& handler) { return handler.feedback.message == "PAUSED"; });
    ...
    auto any_idle = std::any_of(fleet_mission_handlers_.handlers.begin(), fleet_mission_handlers_.handlers.end(),
                                [](const auto& handler) { return handler.feedback.message == "IDLE"; });
  ...
  template <typename ActionServer_T, typename ActionGoal_T, typename ActionResult_T, typename ActionFeedback_T>
  typename BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::robot_mission_handler_t*
  BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::findRobotHandler(const std::string& robot_name,
                                                                                                     fleet_mission_handlers_t& fleet_mission_handlers)
  {
  ...
  void BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::cancelRobotClients()
  {

    {
      ...
      for (auto& rh : fleet_mission_handlers_.handlers)
      {
        ...
        bool lost_robot =
            std::any_of(lost_robot_names_.begin(), lost_robot_names_.end(), [&rh](const auto& lost_robot) { return rh.robot_name == lost_robot; });
  ...
  template <typename ActionServer_T, typename ActionGoal_T, typename ActionResult_T, typename ActionFeedback_T>
  template <typename Svc_T>
  typename BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::result_t
  BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::callService(ros::ServiceClient& sc, typename Svc_T::Request req)
  {
  ...
  template <typename Svc_T>
  typename BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::result_t
  BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::callService(ros::ServiceClient& sc)
  {
  ...
  template <typename ActionServer_T, typename ActionGoal_T, typename ActionResult_T, typename ActionFeedback_T>
  typename BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::result_t
  BaseFleetManager<ActionServer_T, ActionGoal_T, ActionResult_T, ActionFeedback_T>::callService(ros::ServiceClient& sc, const bool val)
  {
